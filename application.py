...
AWS_ACCESS_KEY = 'AKIAJTQB26PLEGGUCGFA'
AWS_SECRET_KEY = '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'
region = 'us-east-1'
...
def main_event_status():
    ...
    if request.method == 'GET':
        ...
        print "host_events", host_events
        print "pending_events", pending_events
        print "accepted_events", accepted_events
        ...
        for event_id in decision_dict:
            if event_id != 'eventDecision':
                ...
                print "event_info:", es.get(index='events', doc_type='default', id=event_id)
        es.index(index='users', doc_type='default', id=curr_user, body=curr_user_info)
        print "user_info:", es.get(index='users', doc_type='default', id=curr_user)
...
if __name__ == '__main__':
    application.run()
    # print es.get(index='events', doc_type='default', id='lyh2_e')
    # print es.search(index='events')
